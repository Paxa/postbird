...
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (undefined, data, column_type_label, types, formatCell) {
var jade_indent = [];
...
buf.push("\n</div>");
jade_debug.shift();
jade_debug.shift();}.call(this,"undefined" in locals_for_with?locals_for_with.undefined:typeof undefined!=="undefined"?undefined:undefined,"data" in locals_for_with?locals_for_with.data:typeof data!=="undefined"?data:undefined,"column_type_label" in locals_for_with?locals_for_with.column_type_label:typeof column_type_label!=="undefined"?column_type_label:undefined,"types" in locals_for_with?locals_for_with.types:typeof types!=="undefined"?types:undefined,"formatCell" in locals_for_with?locals_for_with.formatCell:typeof formatCell!=="undefined"?formatCell:undefined));;return buf.join("");
} catch (err) {
...
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (undefined, data, console, column_type_label, formatCell) {
var jade_indent = [];
...
buf.push("\n</table>");
jade_debug.shift();
jade_debug.shift();}.call(this,"undefined" in locals_for_with?locals_for_with.undefined:typeof undefined!=="undefined"?undefined:undefined,"data" in locals_for_with?locals_for_with.data:typeof data!=="undefined"?data:undefined,"console" in locals_for_with?locals_for_with.console:typeof console!=="undefined"?console:undefined,"column_type_label" in locals_for_with?locals_for_with.column_type_label:typeof column_type_label!=="undefined"?column_type_label:undefined,"formatCell" in locals_for_with?locals_for_with.formatCell:typeof formatCell!=="undefined"?formatCell:undefined));;return buf.join("");
} catch (err) {
...
exports["db_rows_table"].content = "table.native-look-table\n  thead\n    tr\n      each column in data.fields\n        - console.log(column);\n        - var type = column_type_label(column)\n        th(class= 'format-' + type, title= type)= column.name\n  tbody\n    each row in data.rows\n      tr\n        each column in data.fields\n          td!= formatCell(row[column.name], column.udt_name, column.data_type)\n";
...
buf.push("\n  <thead>");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.unshift({ lineno: 33, filename: "/Users/pavel/Sites/postbird/views/procedures_tab.jade" });
buf.push("\n    <tr>");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
...
buf.push("\n  <!--button.native-look(exec=\"runQuery\") Snippets-->");
jade_debug.shift();
jade_debug.shift();
buf.push("\n</div>");
jade_debug.shift();
...
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (undefined, rows, column_type_label, is_mat_view, indexes) {
var jade_indent = [];
...
buf.push("\n</footer>");
jade_debug.shift();
jade_debug.shift();}.call(this,"undefined" in locals_for_with?locals_for_with.undefined:typeof undefined!=="undefined"?undefined:undefined,"rows" in locals_for_with?locals_for_with.rows:typeof rows!=="undefined"?rows:undefined,"column_type_label" in locals_for_with?locals_for_with.column_type_label:typeof column_type_label!=="undefined"?column_type_label:undefined,"is_mat_view" in locals_for_with?locals_for_with.is_mat_view:typeof is_mat_view!=="undefined"?is_mat_view:undefined,"indexes" in locals_for_with?locals_for_with.indexes:typeof indexes!=="undefined"?indexes:undefined));;return buf.join("");
} catch (err) {
