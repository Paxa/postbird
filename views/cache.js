...
pug_html = pug_html + "\u003Ca href=\"http:\u002F\u002Fwww.postgresql.org\u002Fdocs\u002F10\u002Fstatic\u002Fdatatype.html\" target=\"_blank\"\u003E";
;pug_debug_line = 19;pug_debug_filename = "views\u002Fdialogs\u002Fcolumn_form.jade";
...
pug_html = pug_html + "Postbird is PostgreSQL GUI client for macOS, written in JavaScript, runs with Electron.\u003C\u002Fp\u003E";
...
pug_html = pug_html + (null == (pug_interp = link_to("Plain", '#', {exec: 'showPlainPane', class: 'login-with-password'})) ? "" : pug_interp);
;pug_debug_line = 11;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + (null == (pug_interp = link_to("Connect URL", '#', {exec: 'enterPostgresUrl', class: 'enter-postgres-url'})) ? "" : pug_interp);
;pug_debug_line = 12;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + (null == (pug_interp = link_to("Heroku", '#', {exec: 'showHerokuPane1', class: 'login-with-heroku'})) ? "" : pug_interp) + "\n      \u003C\u002Fdiv\u003E";
;pug_debug_line = 14;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "\n      \u003Cform class=\"middle-window-content plain\"\u003E";
