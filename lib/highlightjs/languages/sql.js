    ...
    contains: [
      {
        ...
        beginKeywords:
          ...
          'install uninstall checksum restore check backup revoke refresh vacuum copy',
        ...
        keywords: {
          keyword:
            ...
            'xor year yearweek zon materialized immutable strict refresh vacuum return copy to verbose',
          literal:
            'true false null',
          built_in:
