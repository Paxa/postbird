...
asserts.assert_present = function assert_present (value) {
  if (!Object.present(value)) {
    bdd.onError(new Error("'assert_present' failed: expected '" + JSON.stringify(value) + "' to be present"));
    throw bdd.stopTest;
  }
};
