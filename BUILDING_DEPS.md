...
```
cp /Applications/Postgres.app/Contents/Versions/latest/lib/libpq.5.10.dylib ./vendor/darwin/
...
install_name_tool -change /Applications/Postgres.app/Contents/Versions/10/lib/libssl.1.0.0.dylib @loader_path/libssl.1.0.0.dylib ./vendor/darwin/libpq.5.10.dylib
install_name_tool -change /Applications/Postgres.app/Contents/Versions/10/lib/libcrypto.1.0.0.dylib @loader_path/libcrypto.1.0.0.dylib ./vendor/darwin/libpq.5.10.dylib
install_name_tool -change /Applications/Postgres.app/Contents/Versions/10/lib/libcrypto.1.0.0.dylib @loader_path/libcrypto.1.0.0.dylib ./vendor/darwin/libssl.1.0.0.dylib

# chck with otool

otool -L vendor/darwin/libpq.5.10.dylib
